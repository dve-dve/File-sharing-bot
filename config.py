...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8556089916:AAEzxu5vFSsMs_qjTdltCZY7HqwJ2LN0p40") 
#your api id from https://my.telegram.org/apps
APP_ID = int(os.environ.get("APP_ID", "34552415"))
#your api hash from https://my.telegram.org/apps
API_HASH = os.environ.get("API_HASH", "a41d007169ca0f05f8cb99cd1b3273ec")
#your channel_id from https://t.me/MissRose_bot by forwarding dummy message to rose and applying command `/id` in reply to that message
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003814449485"))
#your id of telegram can be found by https://t.me/MissRose_bot with '/id' command
OWNER_ID = int(os.environ.get("OWNER_ID", "8546199829"))
...
OWNER_TAG = os.environ.get("OWNER_TAG", "evilbuttonmaker_Bot")
